...
const postSchema = Yup.object().shape({
    title: Yup.string().required("Title is required").min(5,"Title should be between 2-20 characters").max(50,"Title should be between 2-50 characters"),
